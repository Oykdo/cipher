...
1. Download `Cipher-Setup-1.2.4.exe` from the [latest release](../../releases/latest).
...
```bash
chmod +x Cipher-1.2.4-x86_64.AppImage
./Cipher-1.2.4-x86_64.AppImage
```

**Debian / Ubuntu** (`.deb`):

```bash
sudo dpkg -i Cipher-1.2.4-amd64.deb
