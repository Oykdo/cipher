...
1. Download `Cipher-Setup-1.4.3.exe` from the [latest release](../../releases/latest).
...
```bash
chmod +x Cipher-1.4.3-x86_64.AppImage
./Cipher-1.4.3-x86_64.AppImage
```

**Debian / Ubuntu** (`.deb`):

```bash
sudo dpkg -i Cipher-1.4.3-amd64.deb
...
*This README describes Cipher as of v1.4.3 (2026-09-12). The French version
