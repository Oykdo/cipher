...
1. Download `Cipher-Setup-1.4.1.exe` from the [latest release](../../releases/latest).
...
>    Get-FileHash .\Cipher-Setup-1.4.1.exe -Algorithm SHA256
>    ```
>
...
```bash
chmod +x Cipher-1.4.1-x86_64.AppImage
./Cipher-1.4.1-x86_64.AppImage
```

**Debian / Ubuntu** (`.deb`):

```bash
sudo dpkg -i Cipher-1.4.1-amd64.deb
...
*This README describes Cipher as of v1.4.1 (2026-09-09). The French version
